...
const natTypeMap: Record<number, NatInfo> = {
  1: { grade: 'excellent', label: '优', color: 'text-green-500', tooltip: 'Open Internet / 开放互联网' },
  2: { grade: 'good', label: '良', color: 'text-blue-500', tooltip: 'Symmetric Firewall / 对称型防火墙' },
  3: { grade: 'good', label: '良', color: 'text-blue-500', tooltip: 'Full Cone NAT / 完全圆锥形NAT' },
  4: { grade: 'poor', label: '差', color: 'text-yellow-500', tooltip: 'Port Restricted Cone NAT / 端口受限圆锥型' },
  5: { grade: 'poor', label: '差', color: 'text-yellow-500', tooltip: 'Symmetric Increment / 对称型递增' },
  6: { grade: 'unavailable', label: '不可用', color: 'text-red-500', tooltip: 'Symmetric NAT / 对称型' },
}
