...
// zoneCache and zoneCacheX are local standalone caches.
// Originally anet used //go:linkname to hook into net.zoneCache and
// golang.org/x/net/internal/socket.zoneCache (Go internal symbols),
// but //go:linkname to internal symbols was restricted in Go 1.24+.
// Since pion/transport uses anet exclusively for interface queries,
// keeping the caches local is sufficient.
